...
alter table "Services" add constraint "SERVICE_FK" foreign key("serviceTypeId") references "SERVICES"("id") on update NO ACTION on delete NO ACTION;

# --- !Downs

alter table "Services" drop constraint "ENV_FK";
alter table "Services" drop constraint "SERVICE_FK";
