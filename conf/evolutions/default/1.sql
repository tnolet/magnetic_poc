...
create table "DOCKER_CONTAINER" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"vrn" VARCHAR NOT NULL,"status" VARCHAR NOT NULL,"imageRepo" VARCHAR NOT NULL,"imageVersion" VARCHAR NOT NULL,"serviceId" BIGINT NOT NULL,"created_at" TIMESTAMP NOT NULL);
