...
create table "CONTAINER_CONFIG" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"host" VARCHAR DEFAULT '127.0.0.1' NOT NULL,"ports" VARCHAR DEFAULT '0' NOT NULL,"weight" BIGINT DEFAULT 0 NOT NULL,"containerId" BIGINT NOT NULL,"created_at" TIMESTAMP NOT NULL);
...
alter table "CONTAINER_CONFIG" add constraint "CONTAINER_FK" foreign key("containerId") references "DOCKER_CONTAINER"("id") on update NO ACTION on delete NO ACTION;
alter table "DOCKER_CONTAINER" add constraint "SERVICE_FK" foreign key("serviceId") references "SERVICES"("id") on update NO ACTION on delete NO ACTION;
...
alter table "CONTAINER_CONFIG" drop constraint "CONTAINER_FK";
