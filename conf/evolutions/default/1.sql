...
create table "DOCKER_CONTAINER" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"vrn" VARCHAR(254) NOT NULL,"status" VARCHAR(254) NOT NULL,"imageRepo" VARCHAR(254) NOT NULL,"imageVersion" VARCHAR(254) NOT NULL,"masterWeight" INTEGER DEFAULT 0 NOT NULL,"instanceAmount" BIGINT NOT NULL,"serviceId" BIGINT NOT NULL,"created_at" TIMESTAMP NOT NULL);
