...
create table "CONTAINER_INSTANCE" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"host" VARCHAR DEFAULT '127.0.0.1' NOT NULL,"ports" VARCHAR DEFAULT '0' NOT NULL,"weight" INTEGER DEFAULT 0 NOT NULL,"mesosId" VARCHAR NOT NULL,"containerId" BIGINT NOT NULL,"created_at" TIMESTAMP NOT NULL);
...
alter table "CONTAINER_INSTANCE" add constraint "CONTAINER_FK" foreign key("containerId") references "DOCKER_CONTAINER"("id") on update NO ACTION on delete NO ACTION;
